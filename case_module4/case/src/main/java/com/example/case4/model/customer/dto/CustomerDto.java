package com.example.case4.model.customer.dto;
...
public class CustomerDto {
    ...
    public CustomerDto(int id, String customerCode, String customerName, String customerBirthday, int customerGender, String customerIdCard, String customerPhone, String customerEmail, String customerAddress, CustomerType customerTypeId) {
        this.id = id;
